...
function ubah(index) {
  alert("Edit | Ini adalah data dengan index ke " + index);
}

function hapus(index) {
  alert("Delete | Ini adalah data dengan index ke " + index);
}
